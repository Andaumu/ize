...
BOT_TOKEN = "8504373990:AAFlk_KCNuLxjeOO2sDnCLnR0vplYuWSOpI"
DATA_FILE = "bot_user_data.json"
OWNER_USER_ID = int(os.environ.get("OWNER_ID", "0"))
ADMIN_USERNAME = "izedentiroty01"

SUPABASE_URL = os.environ.get("SUPABASE_URL", "https://ugauoadvktfmzquwcxdd.supabase.co")
SUPABASE_KEY = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVnYXVvYWR2a3RmbXpxdXdjeGRkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3ODUwMjQ5MSwiZXhwIjoyMDk0MDc4NDkxfQ.lNgCkjFU2lE6880RqlGBYDgz8bm3GDdkTIot0IzGvI0")
supabase: Client = None

# ==================== SEPAY CONFIG ====================
SEPAY_API_TOKEN = os.environ.get("SEPAY_API_TOKEN", "UIXIPM82MYVKMJX9KEHEOSV4YWU40OTEW7AIH6CRWMTDJ3QG5OGB5XAF1FZLNKQC")
SEPAY_ACCOUNT_NUMBER = "05237890382763"  # Thay STK MB Bank của bạn
SEPAY_BIN = "970422"                # Mã BIN MB Bank
